...
CREATE TABLE  [1474_Smerfetka].Expense (ID int IDENTITY NOT NULL, Amount decimal(10, 2) DEFAULT 0 NOT NULL, Place varchar(255) NULL, Time date NOT NULL, IsCyclical bit NOT NULL, DaysCycle int DEFAULT 0 NULL, CurrencyCurrency varchar(3) NOT NULL, CategoryID int NOT NULL, AccountID int NOT NULL, PRIMARY KEY (ID));
...
CREATE TABLE  [1474_Smerfetka].Income (ID int IDENTITY NOT NULL, Amount decimal(10, 2) DEFAULT 0 NOT NULL, Place varchar(255) NULL, Time date NOT NULL, IsCyclical bit NOT NULL, DaysCycle int DEFAULT 0 NULL, CurrencyCurrency varchar(3) NOT NULL, CategoryID int NOT NULL, AccountID int NOT NULL, PRIMARY KEY (ID));
